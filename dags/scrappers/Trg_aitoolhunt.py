...
def Trg_aitoolhunt():
    ...
    def fetchExistingTargetFeatures():
        ...
        result = fetchData(tableName='"DW_RAW"."ref_aitoolhunt_target_features"', columns =['url_ai'])
    ...
    @task()
    def extractTargetFeatures(Ais, table='"DW_RAW"."ref_aitoolhunt_target_features"' ,dag_run: DagRun | None = None):
        """
